...
<div class="wrap">
	...
	<form method="post" action="options.php">
		...
		<div style="clear:both;padding:5px;"><hr></div>
		<div style="float:left;">
		<input type="radio" name="selectstyle" value="8" <? if (get_option('selectstyle')=="8") { echo "checked"; }?>></div>
		<div class="schulp" style="float:left;">&#60;style&#62;  /* Michelle Schulp's (@marktimemedia) pre style */ &#60;/style&#62;</div>
